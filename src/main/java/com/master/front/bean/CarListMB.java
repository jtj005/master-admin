...
import com.master.front.infra.model.Filter;
...
import static com.master.front.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.master.front.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.master.front.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.master.front.infra.model.SortOrder.DESCENDING
                            : com.master.front.infra.model.SortOrder.UNSORTED;
                }
